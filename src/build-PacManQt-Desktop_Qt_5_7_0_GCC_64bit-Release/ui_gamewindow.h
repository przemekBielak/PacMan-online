...
public:
    ...
    void retranslateUi(QWidget *gameWindow)
    {
        ...
        label_lifes_text_4->setText(QApplication::translate("gameWindow", "Player 2", 0));
        label_points->setText(QApplication::translate("gameWindow", "TextLabel", 0));
        label_points_text->setText(QApplication::translate("gameWindow", "Points:", 0));
        label_lifes_num->setText(QApplication::translate("gameWindow", "TextLabel", 0));
        label_points_2->setText(QApplication::translate("gameWindow", "TextLabel", 0));
        label_lifes_num_2->setText(QApplication::translate("gameWindow", "TextLabel", 0));
        label_points_text_2->setText(QApplication::translate("gameWindow", "Points:", 0));
        label_game_level_num->setText(QApplication::translate("gameWindow", "TextLabel", 0));
        label_lifes_text_2->setText(QApplication::translate("gameWindow", "Lifes:", 0));
        label_lifes_text->setText(QApplication::translate("gameWindow", "Lifes:", 0));
        label_player1->setText(QApplication::translate("gameWindow", "Player 1", 0));
        label_game_level->setText(QApplication::translate("gameWindow", "Game Level:", 0));
        label_game_level_2->setText(QApplication::translate("gameWindow", "Use WSAD keys to move", 0));
    } // retranslateUi
