...
#include "../../PacManQt/clientwindow.h"
...
QT_MOC_LITERAL(5, 70, 9) // "readyRead"
    ...
    "activeWidget\0on_pushButton_Join_clicked\0"
    "readyRead"
};
...
void clientwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (clientwindow::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&clientwindow::setActiveWidget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void clientwindow::setActiveWidget(int _t1)
{
